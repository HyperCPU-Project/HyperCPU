...
TEST_F(DECODER_TEST, AND_INSTR_R_IMM_B8) {
...
TEST_F(DECODER_TEST, AND_INSTR_R_IMM_B16) {
  decoder.mem_controller->Load16(counter, HyperCPU::Opcode::AND);
  counter += 2;
...
TEST_F(DECODER_TEST, AND_INSTR_R_IMM_B32) {
  decoder.mem_controller->Load16(counter, HyperCPU::Opcode::AND);
  counter += 2;
...
TEST_F(DECODER_TEST, AND_INSTR_R_IMM_B64) {
  decoder.mem_controller->Load16(counter, HyperCPU::Opcode::AND);
  counter += 2;
