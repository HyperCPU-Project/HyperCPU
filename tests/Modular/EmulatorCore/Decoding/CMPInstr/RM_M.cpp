...
TEST_F(DECODER_TEST, CMP_INSTR_RM_M_B8) {
...
TEST_F(DECODER_TEST, CMP_INSTR_RM_M_B16) {
  decoder.mem_controller->Load16(counter, HyperCPU::Opcode::CMP);
  counter += 2;
...
TEST_F(DECODER_TEST, CMP_INSTR_RM_M_B32) {
  decoder.mem_controller->Load16(counter, HyperCPU::Opcode::CMP);
  counter += 2;
...
TEST_F(DECODER_TEST, CMP_INSTR_RM_M_B64) {
  decoder.mem_controller->Load16(counter, HyperCPU::Opcode::CMP);
  counter += 2;
