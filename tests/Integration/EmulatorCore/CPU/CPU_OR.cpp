...
TEST_F(CPU_TEST, INSTR_OR_R_R_b8) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_R_b16) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_R_b32) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_R_b64) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_RM_b8) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_RM_b16) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_RM_b32) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_RM_b64) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_M_b8) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_M_b16) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_M_b32) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_M_b64) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_IMM_b8) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_IMM_b16) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
...
TEST_F(CPU_TEST, INSTR_OR_R_IMM_b64) {
  cpu.mem_controller->Load16(*cpu.xip, HyperCPU::Opcode::OR);
