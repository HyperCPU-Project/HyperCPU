...
static constexpr auto ident_assoc = mapbox::eternal::map<mapbox::eternal::string, HCAsm::TokenType>({{"adc", HCAsm::TokenType::ADC},
                                                                                                     ...
                                                                                                     {"b8", HCAsm::TokenType::B8},
                                                                                                     {"b16", HCAsm::TokenType::B16},
                                                                                                     {"b32", HCAsm::TokenType::B32},
                                                                                                     {"b64", HCAsm::TokenType::B64}});
